...
urlpatterns = patterns('',
	...
	url(r'^paquetes-requeridos/add/(?P<slug>[\w\-]+)/(?P<id>[0-9]+)/$', views.PaqueteRequeridoView, name='paquetes-requeridos-add'),
	url(r'^paquetes-requeridos/(?P<slug>[\w\-]+)/(?P<id>[0-9]+)/$', views.PaqueteRequeridoListView, name='paquetes-requeridos-list'),
	url(r'^submodulos/(?P<slug>[\w\-]+)/(?P<id>[0-9]+)/$', views.SubmoduloListView.as_view(), name='submodulos-list'),
